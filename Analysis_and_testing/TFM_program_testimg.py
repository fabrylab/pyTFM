...
out_file=r"/home/user/Desktop/test_for_negative_numbers/out.txt"    ## output folder

file1=r"/home/user/Desktop/test_for_negative_numbers/01before_shift.tif" # after image
file2=r"/home/user/Desktop/test_for_negative_numbers/01after_shift.tif" # before image
file3=r"/home/user/Desktop/test_for_negative_numbers/01bf_before_shift.tif" # bf image
...
def onselect1(verts):
    ...
    global contractile_force,center,select,tx_show,ty_show,scale,proj_y,proj_x
    verts_out = verts
...
def show_contractility(event):
    global energy, out_file,proj_x,proj_y,mask,tx,ty
    ...
    plt.quiver(x1, y1, proj_x * scale, -proj_y * scale, scale=1, scale_units='xy', width=0.002)
...
button_ax_cont = plt.axes([0.9, 0.1, 0.1, 0.075])
button_ax_cont.xaxis.set_ticks_position('none')
button_ax_cont.yaxis.set_ticks_position('none')
button_ax_cont.set_xticks([])
button_ax_cont.set_yticks([])
b_cont = Button(button_ax_cont, 'show_contractility')
b_cont.on_clicked(show_contractility)
