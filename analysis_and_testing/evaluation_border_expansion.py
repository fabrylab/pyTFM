...
end_shape_ex = (390,400) #shape fior the border exapnsion plots
border_ex_factor = 0.5 # 0.5 for artificial system, 1 for real data; this factor compensates for the fact that realdata border exapnsion is done by binary delation
...
general_display(plot_types=plot_types, pixelsize=pixelsize, max_dict=max_dict, f_type=f_type,
                ...
                mean_normal_list=mean_normal_list, fields=fields, key_values=measures, plot_gt_exp=False, dm=False, at=False,
                    cb=False)
plt.ion()
